...
<head>
    ...
    <title>Teacher Dashboard - ITE311-MACA</title>
                            ...
                            <div class="card-body">
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item">
                                        ...
                                        <p class="mb-1">John Doe submitted "Midterm Project" in Web Development</p>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <p class="mb-1">From: Jane Smith - Question about the next assignment</p>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <p class="mb-1">You updated the syllabus for Database Management</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item px-0">
                                        ...
                                        <p class="mb-1">Project Proposal Due</p>
                                    </div>
                                    <div class="list-group-item px-0">
                                        <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <p class="mb-1">Midterm Exam</p>
                                    </div>
                                    <div class="list-group-item px-0">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h6 class="mb-1">Algorithms</h6>
                                            <small class="text-muted">Next Week</small>
                                        </div>
                                        <p class="mb-1">Assignment 3 Due</p>
                                    </div>
                                </div>
                            </div>
                        </div>
