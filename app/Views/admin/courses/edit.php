        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/courses/' . $course['id'] . '/update') ?>" method="post">
                        <?= csrf_field() ?>
                                    ...
                                    <select class="form-select" id="teacher_id" name="teacher_id" required>
                                        ...
                                        if (!empty($teachers)):
                                            foreach ($teachers as $teacher): 
                                                $selected = (old('teacher_id', $course['teacher_id']) == $teacher['id']) ? 'selected' : '';
                                        ?>
